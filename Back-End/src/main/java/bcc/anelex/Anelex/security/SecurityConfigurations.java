    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(authorization -> authorization
                        ...
                        .requestMatchers(HttpMethod.GET, "/pet").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/pet").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/pet").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/pet").hasRole("USER")
